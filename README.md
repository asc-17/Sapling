...
|---|---|---|
| `Ai:HuggingFace:ApiKey` (plus optional `Ai:HuggingFace:Model`, default `openai/gpt-oss-120b`) | The mock interviewer and its report, through Hugging Face Inference Providers | A scripted offline interviewer and a generic report are used |
